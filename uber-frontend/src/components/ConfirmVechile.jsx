...
export const ConfirmVechile = ({createRide ,setConfirmVechile, setVechile, setVechileFound, pickup, destination, fare, vechileType }) => {
  return (
    <>
      <div>
        <h5
        ...
        <div className="flex justify-between items-center flex-col">
          ...
          <div className="w-full">
            ...
            <div className="flex items-center gap-5 p-3">
              ...
              <div>
                <h3 className="text-lg font-medium">Rs{fare[vechileType]}</h3>
